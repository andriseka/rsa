      ...
      <div class="container-tight py-4">
        <form class="card card-md" method="POST" action="{{ route('login') }}">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                    <a href="https://www.facebook.com/profile.php?id=100023195133168" target="_blank" class="btn btn-white w-100">
                ...
                <div class="col">
                    <a href="https://www.instagram.com/pripnuippnusrikandang/" target="_blank" class="btn btn-white w-100">
